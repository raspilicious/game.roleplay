...
Not only have I uploaded the PDF "card" version of this game, but also a playable build so that you can run it on a Windows computer. And for those who are interested, you can check out the PDF version of the game on [itch.io](https://aarongoss.itch.io/game-roleplay), and I've uploaded the entire C++ project to GitHub (that's here!) so you can download the code yourself!
